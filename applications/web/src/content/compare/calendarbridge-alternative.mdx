...
blurb: "Keeper.sh is $5 a month however many calendars you have, and copies your busy time without copying your event titles. Here is how the two differ."
...
## Where CalendarBridge is ahead

**Regulated work.** CalendarBridge signs a [HIPAA business associate agreement](https://calendarbridge.com/) on Premium and Pro, and supports Microsoft 365 GCC High; Keeper.sh does neither today.

**Phone apps.** CalendarBridge ships apps on the Apple App Store, Google Play and the [Microsoft Store](https://calendarbridge.com/); Keeper.sh is browser-only.

**Booking pages.** Up to 10 [scheduling pages](https://calendarbridge.com/scheduling-pages-for-people-with-multiple-calendars/) on every plan; Keeper.sh has none.

**Email assistant.** An [AI scheduling assistant](https://calendarbridge.com/ai-scheduling/) on Premium and Pro arranges meetings over email, plus an [MCP server](https://help.calendarbridge.com/user-docs/bring-your-own-agent-mcp/) on every plan.

**Audit paperwork.** A verified SOC 2 Type 1, Type 2 in progress, on its [trust centre](https://trust.calendarbridge.com/).

**Team setup.** [Group plans](https://calendarbridge.com/pricing-group/) let one admin manage everyone's connections on one bill.

**One combined view.** Its unified calendar app shows every calendar on one screen; Keeper.sh gives you a subscribe link instead.
...
Keeper.sh, if what you want is a free start, one flat price however many calendars you carry, or a copy you run yourself. If your requirement is on the CalendarBridge list above — a HIPAA BAA, phone apps, booking pages — that list is the answer.
