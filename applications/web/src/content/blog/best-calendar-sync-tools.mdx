...
- **HIPAA with a signed BAA today, or Microsoft GCC High — CalendarBridge.** Nothing else in this category touches GCC High. That flank costs [$40 a month for eight calendars](https://calendarbridge.com/pricing/), on US cloud only, with no way to run it yourself.
