...
**Named infrastructure.** Their security page states Hetzner hosting in EU data centres (Germany and Finland), an ISO 27001 certified management system, and OAuth tokens encrypted at rest with AES-256-GCM.

The same pages disclose no SOC 2 or application-layer ISO 27001 certification, and several US vendors on the subprocessor list.
...
Choose Keeper.sh for $5 flat however many calendars you have, for event titles stripped by default, or for an agent connector at no cost. SyncDate has the four-second updates and the signed DPA; if either is your requirement, that decides it.
