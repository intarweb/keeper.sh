...
export type PricingFeature = {
   ...
   * stay in the /pricing matrix only. The card bullets are read from here so a
   * plan limit is written down once and the two surfaces cannot drift.
   */
...
/**
 * The 3-5 rows that actually separate the plans, as card bullets. Order follows
 * PRICING_FEATURES so the cards read in the same order as the /pricing matrix.
 */
