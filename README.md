...
| ENCRYPTION_KEY                 | `api`, `cron`, `worker` | Required. Key for encrypting CalDAV credentials and OAuth access/refresh tokens at rest.<br><br>e.g. `openssl rand -base64 32`                                                                                |
